...
export function createGallery(){
    // how many <li> do we need?
    let numberOfImages = 12;
    // create a reference to the #gallery page
    let galleryContainer = document.querySelector("#gallery ul");

    for(var i = 0; i < numberOfImages; i++){
        // create a <li> tag
        let li = document.createElement("li");
        // assign the <li> a grid area number G + number
...
// I found the random image generator here
// https://loremflickr.com/

function generateDogImage(randomNumber){
    // this will ensure we get a different photo back each time
    let queryString = "?random=" + randomNumber ;
    // I combine the url plus the queryString into 1 URL string
    return("url(" + 'https://loremflickr.com/600/600/dog' + queryString + ")");
}